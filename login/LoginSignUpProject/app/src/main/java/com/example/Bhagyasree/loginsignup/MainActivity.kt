...
class MainActivity : AppCompatActivity() {
    ...
    myDataList.add(UserData("bhagyasree","bhagyasree@gmail.com","985412367"))
    myDataList.add(UserData("sujatha","sujatha@gmail.com","8541236977"))
    myDataList.add(UserData("Pinky","pinky@gmail.com","9458712364"))
    myDataList.add(UserData("chinni","chinni@gmail.com","7301245698"))
    myDataList.add(UserData("Sai","sai@gmail.com","7584139945"))
    myDataList.add(UserData("satya","satya@gmail.com","987456321"))
    myDataList.add(UserData("Ganesh","ganesj@gmail.com","874596321"))
